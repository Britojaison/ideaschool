      ...
      >
        <h2 
          style={
            isDark 
              ? { color: "#fff" }
              : { fontSize: "clamp(3rem, 6vw, 5rem)", fontWeight: 900, color: "#000", fontFamily: "'Bebas Neue', var(--font-heading)", margin: 0, textTransform: "uppercase", letterSpacing: "-0.02em", lineHeight: 1 }
          }
        >
