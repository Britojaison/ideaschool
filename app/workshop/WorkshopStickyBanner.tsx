        ...
        >
          ...
          <div className="flex items-center gap-4 w-full md:w-auto justify-between md:justify-end">
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="flex items-center justify-center border border-black rounded-full px-6 py-2 md:py-3 text-black font-medium text-sm md:text-base hover:bg-black hover:text-white transition-colors"
