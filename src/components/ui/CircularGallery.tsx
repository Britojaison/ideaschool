  ...
  return (
    <div
      ...
      className={cn(
        ...
        "bg-[radial-gradient(circle_at_50%_42%,#17171a,#050505)]",
        className,
      )}
      style={{ cursor: "grab" }}
    >
        ...
        {Array.from({ length: count }).map((_, i) => {
          ...
          return (
            <div
              key={i}
              data-ring-item
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-[3px] bg-neutral-700 shadow-md shadow-black/20 ring-1 ring-white/10 [transform-style:preserve-3d]"
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 z-20 bg-[radial-gradient(circle_at_50%_45%,transparent_46%,rgba(5,5,5,0.9))]"
      />
    </div>
  );
}
